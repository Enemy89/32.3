...
inline std::string* Record::mutable_address() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void Record::set_title(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000002u;
...
inline std::string* Record::mutable_title() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void Record::set_allocated_title(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
...
// optional bool economic_activity = 5;
inline bool Record::has_economic_activity() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline void Record::clear_economic_activity() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.economic_activity_ = false;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline bool Record::economic_activity() const {
  // @@protoc_insertion_point(field_get:Record.economic_activity)
  return _internal_economic_activity();
}
inline void Record::set_economic_activity(bool value) {
  _internal_set_economic_activity(value);
  // @@protoc_insertion_point(field_set:Record.economic_activity)
}
inline bool Record::_internal_economic_activity() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.economic_activity_;
}
inline void Record::_internal_set_economic_activity(bool value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000010u;
